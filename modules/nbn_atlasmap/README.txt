NBN Atlas Map taxon formatter output module.

This module allows formatters to be added to the list of taxon formatter presets which use the NBN Atlas grade web service to return a distribution map for a species.

Theme functions
===============

theme_nbn_atlas_map_output($image_path, $response, $preset)
--------------------------------------------
